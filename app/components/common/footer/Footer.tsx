  ...
  return (
    <footer className="bg-footer-pink p-10 space-y-4">
      <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 px-0">
        ...
        {/* Second Column */}
        <div className="flex flex-col space-y-3 items-center sm:items-center md:items-start lg:items-start">
          <Title text="Company" fontSize="text-2xl md:text-lg" />
          <Description text="About us" fontSize="text-lg" />
          <Description text="Contact us" fontSize="text-lg" />
          <Description text="Client" fontSize="text-lg" />
          <Description text="Center" fontSize="text-lg" />
          <Description text="Site Map" fontSize="text-lg" />
        </div>

        {/* Third Column */}
        <div className="flex flex-col space-y-3 items-center sm:items-center md:items-start lg:items-start">
          <Title text="Services" fontSize="text-2xl md:text-lg" />
        ...
        {/* Fourth Column */}
        <div className="flex flex-col space-y-3 items-center sm:items-center md:items-start lg:items-start">
          <Title text="Legal" fontSize="text-2xl md:text-lg" />
